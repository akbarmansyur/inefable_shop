...
class _ProductPageState extends State<ProductPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      //   ],
      //   title: Text(
      //     controller.product.value?.name ?? "name",
        ...
        children: <Widget>[
          SingleChildScrollView(
            child: Column(
              ...
              children: [
                SizedBox(height: Get.size.height / 2, child: ProductDisplay()),
                Padding(
                ...
                Padding(
                  ...
                  child: Text(
                    controller.product.value?.brand ?? "brand",
                ...
                //   ),
                //   child: Text(
                //     controller.product.value?.description ?? "description",
                //     style: const TextStyle(

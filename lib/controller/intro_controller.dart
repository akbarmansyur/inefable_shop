...
class IntroController extends GetxController {
  ...
  final List<IntroModel> items = [
    IntroModel(
      imagePath: 'https://images.unsplash.com/photo-1577525179375-b870f894a365',
    ...
    IntroModel(
      imagePath: 'https://images.unsplash.com/photo-1625562195590-8fb6b0d7fea6',
      title: 'Ekspresi Tanpa Batas',
      description:
          'Desain unik yang merepresentasikan jiwa bebas dan kreatifitas tanpa kompromi.',
    ),
    IntroModel(
      imagePath: 'https://images.unsplash.com/photo-1638863491873-99767d1b8145',
